...
<Steps>
  ...
  <Step title='Check Requirements'>
    Use the [Compliance APIs](/api/nuclues/kyc-requirements-by-isocountry) to checks mandatory fields for your target region.
  </Step>

  <Step title='Onboard Users'>
    Create customers using the [Create Customer API](/api/nuclues/create-customer).
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href='/api/nuclues/list-aml-rules'
  >
