...
api: 'GET https://test-investment-products-service.fincode.software/api/v1/user/portfolios/{customer-id}'
...
<RequestExample>
  ```bash cURL
  curl --request GET 'https://test-investment-products-service.fincode.software/api/v1/user/portfolios/8ecca811-607f-44e1-a57e-cd856c50437d?page=1&size=10' \
...
Returns a paginated list of portfolio entities.
...
<ResponseField name='data' type='array'>
  Array of portfolio entity objects.
  <Expandable title='data array item'>
    <ResponseField name='requestDate' type='string'>
      Date when the investment was requested.
    </ResponseField>
    <ResponseField name='dueDate' type='string'>
      Date when the investment matures or is due.
    </ResponseField>
    <ResponseField name='amountInvested' type='number'>
      Amount that was invested in this portfolio.
    </ResponseField>
    <ResponseField name='totalPayable' type='number'>
      Total amount payable at maturity (principal + interest).
    </ResponseField>
    <ResponseField name='annualPercentageYield' type='number'>
      Annual Percentage Yield (APY) for this investment.
    </ResponseField>
    <ResponseField name='productName' type='string'>
      Name of the investment product.
    </ResponseField>
    <ResponseField name='investmentCategoryName' type='string'>
      Category name of the investment product.
    </ResponseField>
  </Expandable>
</ResponseField>
...
listPortfolios(accessToken, customerId, 1, 20);
```
