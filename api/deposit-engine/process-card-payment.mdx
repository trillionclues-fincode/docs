...
```bash cURL
curl --request POST \
  --url "https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/process-card-payment" \
...
const response = await fetch(
  "https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/process-card-payment",
  {
    method: "POST",
    headers: {
