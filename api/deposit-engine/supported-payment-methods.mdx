...
```bash cURL
curl --request POST \
  --url https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/supported-payment-methods \
...
const response = await fetch('https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/supported-payment-methods', {
  method: 'POST',
  headers: {
