...
```bash cURL
curl --request POST \
  --url "https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/processpaymentwithpaymenttoken" \
...
const response = await fetch(
  "https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/processpaymentwithpaymenttoken",
  {
    method: "POST",
    headers: {
