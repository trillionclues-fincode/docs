...
```bash cURL
curl --request POST \
  --url "https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/payment-methods-charges" \
...
const response = await fetch(
  "https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/payment-methods-charges",
  {
    method: "POST",
    headers: {
