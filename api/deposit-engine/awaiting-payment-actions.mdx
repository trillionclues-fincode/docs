...
```bash cURL
curl --request POST \
  --url "https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/awaiting-payment-actions" \
...
const response = await fetch(
  "https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/awaiting-payment-actions",
  {
    method: "POST",
    headers: {
