...
```bash cURL
curl --request POST \
  --url "https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/notify-bank-transfer-payment" \
...
const response = await fetch(
  "https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/notify-bank-transfer-payment",
  {
    method: "POST",
    headers: {
