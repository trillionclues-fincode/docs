...
```bash cURL
curl --request PUT \
  --url "https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/bank-iwillpaylater-wallet/PCN123/TRANSACTION" \
...
const response = await fetch(
  "https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/bank-iwillpaylater-wallet/PCN123/TRANSACTION",
  {
    method: "PUT",
    headers: {
