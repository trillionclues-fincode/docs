...
api: 'POST https://remitjunction.fincode.software/api/v6/services/usermanagement/create-customer'
...
<RequestExample>
  ```bash cURL POST
  https://https://remitjunction.fincode.software/api/v6/services/usermanagement/create-customer
  ```
</RequestExample>
...
<ResponseField name='customer' type='object'>
  ...
  <Expandable title='customer object'>
    ...
    <ResponseField name='kycStatus' type='string'>
      KYC verification status: `not_started`, `in_progress`, `verified`,
      `failed`
    </ResponseField>

    <ResponseField name='createdAt' type='string'>
      Timestamp when customer was created (ISO 8601)
    </ResponseField>
