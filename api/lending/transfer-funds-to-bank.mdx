...
api: 'POST https://remitjunction.fincode.software/api/v1/services/user/transfer-funds-to-bank'
...
<RequestExample>
  ```bash cURL POST
  [https://remitjunction.fincode.software/api/v1/services/user/transfer-funds-to-bank](https://remitjunction.fincode.software/api/v1/services/user/transfer-funds-to-bank)
  ```
</RequestExample>
...
```bash cURL
curl --location --request POST 'https://remitjunction.fincode.software/api/v1/services/user/transfer-funds-to-bank' \
...
async function transferFundsToBank(accessToken, transferData) {
  try {
    ...
    console.log('Fund transfer initiated successfully!');
