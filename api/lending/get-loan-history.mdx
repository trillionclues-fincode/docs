---
title: 'Loan History'
openapi: 'GET /user/get-loan-history/{customerId}'
...
```bash cURL
curl --location 'https://{your-domain}.fincode.software/api/v1/services/user/loan-history/123e4567-e89b-12d3-a456-426614174000?page=1&size=10' \
