---
title: 'Calculate APR'
api: 'POST https://{your-domain}.fincode.software/api/v1/services/user/calculate-apr'
...
<RequestExample>
  ```bash cURL POST
  https://{your-domain}.fincode.software/api/v1/services/user/calculate-apr
  ```
</RequestExample>
...
```bash cURL
curl --location --request POST 'https://{your-domain}.fincode.software/api/v1/services/user/calculate-apr' \
