...
api: 'POST https://finlend.fincode.software/api/v1/services/user/create-transaction-pin'
...
<RequestExample>
  ```bash cURL POST
  [https://finlend.fincode.software/api/v1/services/user/create-transaction-pin](https://finlend.fincode.software/api/v1/services/user/create-transaction-pin)
  ```
</RequestExample>
...
```bash cURL
curl --location --request POST 'https://finlend.fincode.software/api/v1/services/user/create-transaction-pin' \
