...
api: 'GET https://remitjunction.fincode.software/api/v1/services/user/check-transfer-status/{transactionReference}'
...
<RequestExample>
  ```bash cURL GET
  [https://remitjunction.fincode.software/api/v1/services/user/check-transfer-status/{transactionReference}](https://remitjunction.fincode.software/api/v1/services/user/check-transfer-status/{transactionReference})
  ```
</RequestExample>
...
```bash cURL
curl --location 'https://remitjunction.fincode.software/api/v1/services/user/check-transfer-status/TXN-20240115-001234' \
...
async function checkTransferStatus(accessToken, transactionReference) {
  try {
    ...
    console.log(`Reference: ${status.transactionReference}`);
    console.log(`Status: ${status.transferStatus}`);
