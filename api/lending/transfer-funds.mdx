...
api: 'POST https://{your-domain}.fincode.software/api/v1/services/user/transfer-funds-to-bank'
...
<RequestExample>
  ```bash cURL POST
  https://{your-domain}.fincode.software/api/v1/services/user/transfer-funds-to-bank
  ```
</RequestExample>
...
```bash cURL
curl --location --request POST 'https://{your-domain}.fincode.software/api/v1/services/user/transfer-funds-to-bank' \
