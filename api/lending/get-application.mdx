...
api: 'GET https://finlend.fincode.software/api/v6/services/admin/loan-application/{loan-application-id}'
...
<RequestExample>
  ```bash cURL GET
  [https://finlend.fincode.software/api/v6/services/admin/loan-application/{loan-application-id}](https://finlend.fincode.software/api/v6/services/admin/loan-application/loan-application/{loan-application-id})
  ```
</RequestExample>
