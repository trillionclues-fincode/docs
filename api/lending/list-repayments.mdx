...
```bash cURL
curl --location 'https://{your-domain}.fincode.software/api/v6/services/admin/repayments/list?page=1&size=10&status=VERIFIED' \
...
const BASE_URL = 'https://{your-domain}.fincode.software/api/v6/services/admin/repayments';
