...
api: 'POST https://{your-domain}.fincode.software/api/v1/services/user/create-bank-account'
...
<RequestExample>
  ```bash cURL POST
  https://{your-domain}.fincode.software/api/v1/services/user/create-bank-account
  ```
</RequestExample>
...
```bash cURL
curl --location --request POST 'https://{your-domain}.fincode.software/api/v1/services/user/create-bank-account' \
