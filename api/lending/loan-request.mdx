---
title: 'Request Loan'
api: 'POST https://remitjunction.fincode.software/api/v6/services/user/request-loan'
...
<RequestExample>
  ```bash cURL POST
  [https://remitjunction.fincode.software/api/v6/services/user/request-loan](https://remitjunction.fincode.software/api/v6/services/user/request-loan)
  ```
</RequestExample>
...
```bash cURL
curl --location --request POST 'https://remitjunction.fincode.software/api/v6/services/user/request-loan' \
...
const BASE_URL = 'https://remitjunction.fincode.software/api/v6/services/user';
