---
title: 'Payoff Loan'
api: 'POST https://remitjunction.fincode.software/api/v1/services/user/payoff-loan'
...
<RequestExample>
  ```bash cURL POST
  [https://remitjunction.fincode.software/api/v1/services/user/payoff-loan](https://remitjunction.fincode.software/api/v1/services/user/payoff-loan)
  ```
</RequestExample>
...
```bash cURL
curl --location --request POST 'https://remitjunction.fincode.software/api/v1/services/user/payoff-loan' \
...
async function payoffLoan(accessToken, payoffData) {
  try {
    ...
    console.log('Payoff Amount:', response.data.data.payoffAmount);
    console.log('Remaining Balance:', response.data.data.remainingBalance);
    console.log('Loan Status:', response.data.data.loanStatus);
