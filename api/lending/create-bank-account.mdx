...
api: 'POST https://remitjunction.fincode.software/api/v1/services/user/create-bank-account'
...
<RequestExample>
  ```bash cURL POST
  [https://remitjunction.fincode.software/api/v1/services/user/create-bank-account](https://remitjunction.fincode.software/api/v1/services/user/create-bank-account)
  ```
</RequestExample>
...
```bash cURL
curl --location --request POST 'https://remitjunction.fincode.software/api/v1/services/user/create-bank-account' \
