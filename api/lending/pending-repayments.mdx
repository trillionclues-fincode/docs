---
title: 'Get Pending Repayments'
api: 'GET https://remitjunction.fincode.software/api/v1/services/user/pending-repayments/{user-id}'
...
<RequestExample>
  ```bash cURL GET
  [https://remitjunction.fincode.software/api/v1/services/user/pending-repayments/{user-id}](https://remitjunction.fincode.software/api/v1/services/user/pending-repayments/{user-id})
  ```
</RequestExample>
...
```bash cURL
curl --location 'https://remitjunction.fincode.software/api/v1/services/user/pending-repayments/123e4567-e89b-12d3-a456-426614174000?page=1&size=10' \
...
async function getPendingRepayments(accessToken, userId, page = 1, size = 10) {
  try {
    ...
    const repayments = response.data.data;
