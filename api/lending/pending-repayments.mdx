...
api: 'GET https://{your-domain}.fincode.software/api/v1/services/user/pending-repayments/{user-id}'
...
<RequestExample>
  ```bash cURL GET
  https://{your-domain}.fincode.software/api/v1/services/user/pending-repayments/{user-id}
  ```
</RequestExample>
...
```bash cURL
curl --location 'https://{your-domain}.fincode.software/api/v1/services/user/pending-repayments/123e4567-e89b-12d3-a456-426614174000?page=1&size=10' \
