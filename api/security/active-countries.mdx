...
openapi: 'GET /utilitiesmanagement/active-countries'
...
```bash cURL
curl --location 'https://{your-domain}.fincode.software/api/v6/services/utilitiesmanagement/active-countries' \
...
const BASE_URL =
  'https://{your-domain}.fincode.software/api/v6/services/utilitiesmanagement';
