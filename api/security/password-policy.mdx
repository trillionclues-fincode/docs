...
```bash cURL
curl --location 'https://{your-domain}.fincode.software/api/v6/services/admin/security/view-password-policy' \
...
const BASE_URL =
  'https://{your-domain}.fincode.software/api/v6/services/admin/security';
