...
```bash cURL
curl --location 'https://{your-domain}.fincode.software/api/v6/services/admin/organisation-preference-management/fetch-organisaction-preference' \
...
const BASE_URL =
  'https://{your-domain}.fincode.software/api/v6/services/admin/organisation-preference-management';
