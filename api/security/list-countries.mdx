...
openapi: 'GET /utilitiesmanagement/list-all-countries'
...
```bash cURL
curl --location 'https://{your-domain}.fincode.software/api/v6/services/utilitiesmanagement/list-all-countries' \
