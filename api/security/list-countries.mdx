...
api: "GET https://remitjunction.fincode.software/api/v6/services/utilitiesmanagement/list-all-countries"
...
<RequestExample>
          ```bash cURL GET        
  [https://remitjunction.fincode.software/api/v6/services/utilitiesmanagement/list-all-countries](https://remitjunction.fincode.software/api/v6/services/utilitiesmanagement/list-all-countries)
          ```
</RequestExample>
...
The response returns an object detailing all the countries of the world with their different iso3Codes.
