...
```bash cURL
curl -X PUT "https://{your-domain}.fincode.software/api/v6/services/securitymanagement/login" \
...
public class FinCodeLogin {
    ...
    public static LoginResponse login(String email, String password) throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder()
            .uri(URI.create("https://{your-domain}.fincode.software/api/v6/services/securitymanagement/login"))
