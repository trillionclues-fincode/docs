...
api: 'GET https://{domain}.fincode.software/api/v6/services/account-maintenance/change-account-permission/{id}/{permission}'
...
<RequestExample>
  ```bash cURL GET
  [https://{domain}.fincode.software/api/v6/services/account-maintenance/change-account-permission/{id}/{permission}](https://{domain}.fincode.software/api/v6/services/account-maintenance/change-account-permission/{id}/{permission})
  ```
</RequestExample>
...
<ResponseField name='data' type='object'>
  ...
  <Expandable title='data object'>
    ...
    <ResponseField name='permission' type='string'>
      Updated account permission level.
    </ResponseField>
...
const permission = 'READ_ONLY'; // or other permission values
changeAccountPermission(accessToken, accountId, permission);
```
