...
api: 'POST /paymentmanagement/supported-payment-methods'
...
<RequestExample>
  ```bash cURL POST
  https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/supported-payment-methods
  ```
</RequestExample>
...
```bash cURL
curl -X POST 'https://{your-domain}.fincode.software/api/v6/services/paymentmanagement/supported-payment-methods' \
