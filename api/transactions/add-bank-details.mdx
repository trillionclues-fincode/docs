...
api: 'POST https://remitjunction.fincode.software/api/v6/services/bankmanagement/add-bank-details-key-value-pairs'
...
<RequestExample>
  ```bash cURL POST
  [https://remitjunction.fincode.software/api/v6/services/bankmanagement/add-bank-details-key-value-pairs](https://remitjunction.fincode.software/api/v6/services/bankmanagement/add-bank-details-key-value-pairs)
  ```
</RequestExample>
