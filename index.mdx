---
title: "Welcome to FinCode"
description: "Enterprise-grade multitenant platform for remittance, digital lending, investment services, and crossboarder transaction switching."
icon: "sack-dollar"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Authentication Guide" icon="key" href="/authentication">
    Learn about API keys, OAuth 2.0, and tenant-scoped tokens.
  </Card>
  <Card
