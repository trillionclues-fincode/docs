...
- **Flexible Disbursement** - Funds can be disbursed to wallets, bank accounts, or cash
...
<CardGroup cols={2}>
  <Card title='Automated Credit Assessment'>
    Automated credit scoring and risk evaluation using multiple data sources including credit bureaus, transaction history, and alternative data.
  </Card>
  ...
  <Card title='Flexible Disbursement'>
    Disburse loans to customer wallets, bank accounts, or cash pickup locations.
  </Card>
...
<Steps>
  ...
  <Step title='Underwriting & Approval'>
    Loan officers review applications, approve or reject based on risk assessment, and set loan terms.
  </Step>

  <Step title='Disbursement'>
    Approved loans are disbursed to customer wallets, bank accounts, or cash pickup locations.
  </Step>
...
<Info>
  For detailed visual flow, see the [Application Flow](/lending/application-flow) and [Loan Lifecycle](/lending/loan-lifecycle) pages.
</Info>
...
<Card title='Learn More' href='/lending/application-flow'>
...
<Card title='Learn More' href='/lending/repayment'>
...
<Steps>
  ...
  <Step title='Understand the Flow'>
    Read through the [Application Flow](/lending/application-flow) to understand the complete loan journey.
  </Step>
</Steps>
...
Once the offer is accepted, funds are disbursed via:
- **Wallet Transfer** - Instant credit to customer wallet
- **Bank Transfer** - Direct deposit to bank account
- **Cash Pickup** - Customer collects at agent location
...
<Card title='View Complete Flow' href='/lending/application-flow'>
...
<Tabs>
  <Tab title="Full Customer Journey">
    ...
    **Documentation**:
    - [Complete Application Flow](/lending/application-flow)
...
<CardGroup cols={2}>
  ...
  <Card title='Credit Scoring' icon='chart-line' href='/lending/credit-scoring'>
    Learn about credit assessment and risk evaluation
  </Card>

  <Card title='Start Integrating' icon='rocket' href='/api/lending/loan-request'>
