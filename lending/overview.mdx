...
<Steps>
  ...
  <Step title='Disbursement'>
    Approved loans are disbursed to customer wallets, which can then be transferred to bank accounts, or cash pickup locations.
  </Step>
...
- **Bank Transfer** - Direct deposit can then be initiated to bank account
- **Cash Pickup** - Customer can also collect at agent location
