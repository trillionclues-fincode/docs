...
1. const managerDomain = "https://remitjunction.fincode.software/api/v6/services/securitymanagement/login"

2. const agentAndCustomerDomain = "https://agent.fincode.software/api/v6/services/securitymanagement/login"

3. const cashierDomain = "https://agent.fincode.software/api/v6/services/securitymanagement/login"
